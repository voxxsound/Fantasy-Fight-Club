  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created club as @club" do
        Club.stub(:new).with({'these' => 'params'}).and_return(mock_club(:save => true))
        post :create, :club => {:these => 'params'}
        assigns[:club].should equal(mock_club)
      end

      it "redirects to the created club" do
        Club.stub(:new).and_return(mock_club(:save => true))
        post :create, :club => {}
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved club as @club" do
        Club.stub(:new).with({'these' => 'params'}).and_return(mock_club(:save => false))
        post :create, :club => {:these => 'params'}
        assigns[:club].should equal(mock_club)
      end

      it "re-renders the 'new' template" do
        Club.stub(:new).and_return(mock_club(:save => false))
        post :create, :club => {}
